...
async function main() {
  ...
  const CertificateOfParticipationNFT = await hre.ethers.getContractFactory("CertificateOfParticipationNFT");
  const certificateOfParticipationNFT = await CertificateOfParticipationNFT.deploy();
